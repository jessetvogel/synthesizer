...
public class Response {
    ...
    public NodeInfo getNodeInfo() {
        try {
            ...
            // Sort inputs and outputs on label
            Arrays.sort(nodeInfo.inputs, Comparator.comparing(a -> a.label)); // TODO: better solution, this does not work
            Arrays.sort(nodeInfo.outputs, Comparator.comparing(a -> a.label));
    ...
    public Settings getSettings() {
        try {
            ...
            JSONObject obj = json.getJSONObject("settings");

            settings.sampleRate = json.getDouble("sampleRate");
            settings.bufferSize = json.getInt("bufferSize");
            settings.sustainPedalPolarity = json.getString("sustainPedalPolarity").equals("inverted");
            settings.pitchWheelRange = json.getDouble("pitchWheelRange");
